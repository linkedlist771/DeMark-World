...
from ..schema import Device, InteractiveSegModel, RealESRGANModel
...
def build_plugins(
    ...
    if enable_interactive_seg:
        ...
        plugins[InteractiveSeg.name] = InteractiveSeg(interactive_seg_model, interactive_seg_device)
    ...
    if enable_gfpgan:
        ...
        if enable_realesrgan:
            ...
            logger.info(f"GFPGAN no background upscaler, use --enable-realesrgan to enable it")
