        ...
        with gr.Tabs():
            with gr.Tab("Common"):
                ...
                with gr.Row():
                    ...
                    downloaded_model = gr.Dropdown(downloaded_models, label="Downloaded Models")
                with gr.Column():
                    model = gr.Textbox(
                        init_config.model,
                ...
                device = gr.Radio(Device.values(), label="Device", value=init_config.device)
                quality = gr.Slider(
                    value=95,
            ...
            with gr.Tab("Plugins"):
                ...
                with gr.Row():
                    enable_gfpgan = gr.Checkbox(init_config.enable_gfpgan, label=GFPGAN_HELP)
