    ...
    class BatchProcessorImpl:
        ...
        def process_batch(self):
            ...
            with Progress(
                ...
                batch_task = progress.add_task("[cyan]Overall Progress", total=len(video_files))
                ...
                for idx, input_path in enumerate(video_files, 1):
                    ...
                    try:
                        video_task = progress.add_task("  [green]Processing video", total=100)
        ...
        def _print_summary(self, start_time: datetime):
            ...
            summary_table.add_row("Successful", f"[bold green]{len(self.successful)}[/bold green]")
            summary_table.add_row("Failed", f"[bold red]{len(self.failed)}[/bold red]")
